      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Nama Jeep</label>
            <input type="text" name="nama_jeep" value="<?=$detail->nama_jeep?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Nama Jeep" required>
          </div>
          <div class="form-group">
