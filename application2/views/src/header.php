...
<head>
  ...
  <title>JeepQuestReserved</title>
</head>
<body>

  <div class="navbar-title" style="height: 80px;">
   <span class="head1" style="color: white;">JeepQuest</span><span class="head2">Reserved</span>
   <p>Wherever and <span class="underline">Whenever</span></p>
 </div>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav" style="font-weight: bolder;">
      ...
      if($level==1){
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?=base_url('jeep')?>">Data Mobil Jeep</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?=base_url('paketour')?>">Data Paket</a>
        </li>
        <li class="nav-item">
      ...
      <?php }elseif($level==2){
        ?>
        <li class="nav-item">
          <a class="nav-link" href="<?=base_url('order/paket')?>">Pemesanan</a>
        </li>
        <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="account nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white;">
