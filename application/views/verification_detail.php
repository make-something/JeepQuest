      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="text-purple text-bold">Jeep</label>
                <p><?=$detail->nama_paket?> - <?=$detail->nama_kota?></p>
              </div>
              <div class="form-group">
                <label class="text-purple text-bold">Paket</label>
                <p><?=$detail->jumlah_penumpang?> <?=$paket?></p>
              </div>
              <div class="form-group">
...
<div class="modal fade" id="terimaModal" tabindex="-1" role="dialog" aria-labelledby="terimaModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="terimaModalLabel">Input Nomor Jeep</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
