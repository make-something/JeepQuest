        ...
        <div class="card-body">
          ...
          ?>
              <div class="alert alert-success" role="alert">
                ...
                <p class="mb-0">Silahkan tunjukan halaman ini kepada resepsionis Jeep untuk mendapatkan  tiket anda.</p>
              </div>
              <b>Nomor Jeep</b> : <span class="badge badge-primary"><?=$detail->nomor_jeep?></span>
            <hr>
          <?php
        }
        ?>
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <p><?=$detail->nama_paket?> </p>
            </div>
            <div class="form-group">
              <label class="text-purple text-bold">Jenis Paket</label>
              <p><?=$detail->paket?> </p>
            </div>
            <div class="form-group">
              <label class="text-purple text-bold">Jumlah Paket</label>
              <p><?=$detail->jumlah_penumpang?> </p>
            </div>
            <!-- <div class="form-group">
              <label class="text-purple text-bold"></label>
              <p><?=tanggal($detail->checkin)?></p>
            </div> -->
          
          </div>
        </div>
        <a href="<?=base_url('order/my')?>" class="btn btn-primary float-right">Kembali</a>
      </div>
    </div>
  </div>
</div>
